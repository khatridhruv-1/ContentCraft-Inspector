...
export const WELCOME_FAQ_ITEMS: WelcomeFaqItem[] = [
  {
    ...
    answer:
      'BlogCreator is a workspace for humanized, platform-native content. Pick where you publish, draft in a clear practitioner voice, discover keywords, and run SEO analysis — so the piece reads like a person wrote it, not a generic chat dump.',
    tag: 'Overview',
  },
  {
    question: 'Can I generate content for different platforms?',
    answer:
      'Yes. Choose a platform before you draft — Personal website, LinkedIn, Quora, Medium, or Substack. BlogCreator adapts structure, length, and voice to match where you publish, then discovers keywords for your topic.',
    tag: 'Generation',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes — BlogCreator is currently free for everyone. Sign up to draft humanized content, discover keywords, and run core analysis. No paid tier is required to start.',
    tag: 'Pricing',
  },
  {
  ...
  },
  {
    ...
    answer:
      'BlogCreator is built for humanized publishing — platform-specific structure, keyword discovery, SEO scoring, outlines, and content-gap analysis in one tool. General chat assistants require you to assemble those steps manually and often sound generic.',
    tag: 'Comparison',
  },
  {
    question: 'Can I use BlogCreator inside Cursor, Claude, or other agents?',
    answer:
      'Yes. Install the MCP tool or agent skill with one Terminal command — it connects to our hosted API so your agent can draft content, run analysis, and build outlines without local API keys. See the Integrations section on this page or visit /integrate for the full setup guide.',
    tag: 'Integrations',
  },
  {
