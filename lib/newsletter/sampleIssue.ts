export const NEWSLETTER_SAMPLE_ISSUES = [
  {
    id: 'july-12-2026',
    date: 'July 12, 2026',
    topic: 'How small teams ship humanized content without sounding generic',
    keywords: [
      'humanized content',
    ...
    intro:
      'Search interest in faster publishing keeps climbing — but most teams still struggle with one thing: output that reads like a person wrote it. Here is a practitioner take on what is actually working this week.',
    sections: [
      {
        heading: 'Start with platform intent, not a blank page',
        body:
          'The teams seeing the best results pick a destination first — website, LinkedIn, newsletter — then draft. Platform-aware structure beats dumping everything into a generic chat thread and hoping the tone lands.',
      },
      {
        heading: 'Layer keyword discovery before you edit',
        body:
          'Live keyword signals still matter for discoverability. Weave high-intent terms into drafts while writing, then run a readability and gap pass so the final piece does not feel stuffed.',
      },
      {
        heading: 'Keep a human editor in the loop',
        body:
          'A first draft is a starting point. The best published work adds a specific example, a contrarian line, or a first-person observation — the parts search snippets cannot fake.',
      },
    ],
    closing:
