...
import { Wand2, FileSearch, Gauge } from 'lucide-react';
      ...
      <div className="mx-auto max-w-6xl">
        ...
        >
          ...
          <h2 id="preview-heading" className="text-3xl font-black tracking-tight text-white md:text-4xl">
            One workspace for{' '}
            <span className="text-violet-400">your full workflow</span>
          </h2>
          <p className="mx-auto mt-3 max-w-xl text-base text-white/70">
            Generate drafts, refine in the editor, then run SEO and AI-detection analysis — without switching tools.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="grid gap-2 p-2 md:grid-cols-[1.4fr_1fr] md:gap-3 md:p-3">
            <div className="rounded-xl border border-white/[0.08] bg-[#0f0f12] p-4">
              ...
              <div className="space-y-2">
                ...
                <div className="mt-4 h-16 rounded-lg border border-violet-500/20 bg-violet-500/[0.08] p-3 text-[11px] text-violet-200/80">
                  AI suggestion: tighten intro and add a clearer CTA in paragraph two.
                </div>
              </div>
            </div>

            <div className="space-y-2">
              <div className="rounded-xl border border-white/[0.08] bg-[#0f0f12] p-3">
              ...
              <div className="rounded-xl border border-white/[0.08] bg-[#0f0f12] p-3">
                <div className="mb-2 flex items-center gap-2 text-xs font-semibold text-white/70">
                  <Gauge className="h-3.5 w-3.5 text-pink-400" aria-hidden />
                  Realness Score
                </div>
                <div className="flex items-end justify-between">
                  <span className="text-2xl font-black text-white">Human-like</span>
                  <span className="text-[10px] text-white/45">Low AI signal</span>
                </div>
              </div>
            </div>
          </div>
