...
import { Wand2, Edit, FileSearch, Sparkles, Menu, X } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex flex-col">
        ...
        {/* Navbar */}
        <header className="relative z-20 w-full px-6 py-4 flex items-center justify-between bg-white/80 backdrop-blur-sm shadow-sm">
          <div className="flex items-center gap-2">
            <Sparkles className="w-6 h-6 text-blue-600" />
            <span className="font-bold text-gray-900">ContentCraft Inspector</span>
          </div>
          ...
          <div className="hidden md:flex items-center gap-3">
            <button
              ...
              className="text-gray-700 px-4 py-2 rounded-lg font-medium hover:bg-gray-100 transition-colors"
            >
              Sign In
            </button>
            <button
        ...
        {menuOpen && (
          <div className="relative z-10 md:hidden bg-white shadow-lg w-full px-6 py-4 flex flex-col gap-4">
            <a
              href="#features"
