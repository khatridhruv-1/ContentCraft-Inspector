...
export default function HelpProductVideoSection() {
  return (
    <section className={cn(marketingPageContainerMedium, 'py-12 md:py-16')} aria-labelledby="help-video-heading">
      ...
      <div className={cn(marketingGlassCard, 'relative mx-auto mt-6 max-w-2xl overflow-hidden')}>
        <div className="flex aspect-video flex-col items-center justify-center bg-gradient-to-br from-slate-900 to-teal-950 px-6 text-center">
          ...
          <Link
            href="/help#preview"
            className="mt-4 rounded-full bg-teal-600 px-5 py-2 text-sm font-semibold text-white hover:bg-teal-500"
          >
            Start 60s tour
          </Link>
        </div>
